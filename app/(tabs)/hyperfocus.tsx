...
const HyperfocusScreen = () => {
  ...
  }, [router, isBreak, updateTaskTimeSpent]);
  ...
  // If no taskId is provided, show a task selection screen
  if (!taskId) {
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.content}>
          <Text style={styles.errorText}>Please select a task from the Focus Mode screen</Text>
          <TouchableOpacity
