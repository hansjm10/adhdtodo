...
import { useUser, useTasks } from '../../src/contexts';
import TaskItem from '../../src/components/TaskItem';
import { TASK_CATEGORIES } from '../../src/constants/TaskConstants';
import { TaskCategory, Task } from '../../src/types/task.types';
    ...
    return (
      <TaskItem
        ...
        onPress={() =>
          router.push({
            pathname: '/task/[id]',
            params: { id: taskForNavigation.id, task: JSON.stringify(taskForNavigation) },
          })
        }
