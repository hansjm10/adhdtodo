...
import { terminatePartnership } from '../utils/PartnershipModel';
import { PARTNERSHIP_STATUS, USER_ROLE } from '../constants/UserConstants';
import { User, Partnership, UserRole } from '../types/user.types';
import { PartnershipStackParamList } from '../navigation/AppNavigator';

type PartnershipScreenNavigationProp = StackNavigationProp<
  PartnershipStackParamList,
  'Partnership'
>;

interface PartnershipScreenProps {
  navigation: PartnershipScreenNavigationProp;
}
      ...
      <View style={styles.actionsContainer}>
        {currentUser?.role !== USER_ROLE.ADHD_USER && (
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('TaskAssignment', { taskId: '' })}
          >
